...
/**
 *          Suppose that, instead of a DStack interface, you were  given a fully-functional FIFO Queue class. 
 *          How might you implement this project (i.e., simulate a Stack) with one or more instances of
 *          a FIFO Queue?
 * 
...
public class QueueStack implements DStack {
    ...
    /**
     * Pushes the value onto the stack represented by this queue. 
     * In other words, inserts the element at the front of this queue.
     * 
     * parameter value: the value that push into the stack
     */
    @Override
